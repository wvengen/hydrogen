...
class Instrument : public Object
{
    ...
    public:
        ...
        const QString& get_name() const             { return __name; }  ///< \brief get the name of the instrument

        void set_id( const int id )                 { __id = id; }      ///< \brief set the id of the instrument
        int get_id() const                          { return __id; }    ///< \brief get the id of the instrument

        void set_adsr( ADSR* adsr );                                    ///< \brief set the ADSR of the instrument
        ADSR* get_adsr() const                      { return __adsr; }  ///< \brief get the ADSR of the instrument

        void set_mute_group( int group )            { __mute_group = group; }   ///< \brief set the mute group of the instrument
        int get_mute_group() const                  { return __mute_group; }    ///< \brief get the mute group of the instrument

        void set_midi_out_channel( int channel );                                   ///< \brief set the midi out channel of the instrument
        int get_midi_out_channel() const            { return __midi_out_channel; }  ///< \brief get the midi out channel of the instrument

        void set_midi_out_note( int note );                                         ///< \brief set the midi out note of the instrument
        int get_midi_out_note() const               { return __midi_out_note; }     ///< \brief get the midi out note of the instrument

        void set_muted( bool muted )                { __muted = muted; }    ///< \brief set muted status of the instrument
        bool is_muted() const                       { return __muted; }     ///< \brief get muted status of the instrument

        void set_pan_l( float val )                 { __pan_l = val; }      ///< \brief set left pan of the instrument
        float get_pan_l() const                     { return __pan_l; }     ///< \brief get left pan of the instrument

        void set_pan_r( float val )                 { __pan_r = val; }      ///< \brief set right pan of the instrument
        float get_pan_r() const                     { return __pan_r; }     ///< \brief get right pan of the instrument

        void set_gain( float gain )                 { __gain = gain; }      ///< \brief set gain of the instrument
        float get_gain() const                      { return __gain; }      ///< \brief get gain of the instrument

        void set_volume( float volume )             { __volume = volume; }  ///< \brief set the volume of the instrument
        float get_volume() const                    { return __volume; }    ///< \brief get the volume of the instrument

        void set_filter_active( bool active )       { __filter_active = active; }   ///< \brief activate the filter of the instrument
        bool is_filter_active() const               { return __filter_active; }     ///< \brief get the status of the filter of the instrument

        void set_filter_resonance( float val )      { __filter_resonance = val; }   ///< \brief set the filter resonance of the instrument
        float get_filter_resonance() const          { return __filter_resonance; }  ///< \brief get the filter resonance of the instrument

        void set_filter_cutoff( float val )         { __filter_cutoff = val; }      ///< \brief set the filter cutoff of the instrument
        float get_filter_cutoff() const             { return __filter_cutoff; }     ///< \brief get the filter cutoff of the instrument

        void set_peak_l( float val )                { __peak_l = val; }     ///< \brief set the left peak of the instrument
        float get_peak_l() const                    { return __peak_l; }    ///< \brief get the left peak of the instrument

        void set_peak_r( float val )                { __peak_r = val; }     ///< \brief set the right peak of the instrument
        float get_peak_r() const                    { return __peak_r; }    ///< \brief get the right peak of the instrument

        void set_fx_level( float level, int index ) { __fx_level[index] = level; }  ///< \brief set the fx level of the instrument
        float get_fx_level( int index ) const       { return __fx_level[index]; }   ///< \brief get the fx level of the instrument

        void set_random_pitch_factor( float val )   { __random_pitch_factor = val; }    ///< \brief set the random pitch factor of the instrument
        float get_random_pitch_factor() const       { return __random_pitch_factor; }   ///< \brief get the random pitch factor of the instrument

        void set_active( bool active )              { __active = active; }      ///< \brief set the active status of the instrument
        bool is_active() const                      { return __active; }        ///< \brief get the active status of the instrument

        void set_soloed( bool soloed )              { __soloed = soloed; }      ///< \brief set the soloed status of the instrument
        bool is_soloed() const                      { return __soloed; }        ///< \brief get the soloed status of the instrument

        void enqueue()                              { __queued++; }                         ///< \brief enqueue the instrument
        void dequeue()                              { assert( __queued > 0 ); __queued--; } ///< \brief dequeue the instrument
        int is_queued() const                       { return __queued; }                    ///< \brief get the queued status of the instrument

        void set_stop_notes( bool stopnotes )       { __stop_notes = stopnotes; }   ///< \brief set the stop notes status of the instrument
        bool is_stop_notes() const                  { return __stop_notes; }        ///< \brief get the stop notes of the instrument
